...
void GameOver::dibujar() {
    ...
    SDL_Texture* tit = Texture::LoadText("Game Over", rojo, this->renderer1);
    SDL_Texture* teclas = Texture::LoadText("Presione X para Salir", blanco, this->renderer1);

    Texture::draw_text(tit, titulo, renderer1);
    Texture::draw_text(teclas, tecla, renderer1);
