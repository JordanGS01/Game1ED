...
## Controles del juego
 Para el movimiento del personaje se utilizan las cuatro flechas del teclado (up, down, left, right). Dentro del juego, a la hora de precipar la tecla "P" se accede a un menú de pausa, donde se permite guardar o salir de la partida.
...
## Analisis de resultados segunda etapa
...
**Estructura de los archivos utilizados para el guardado**
 ...
 ## Analisis de resultados tercera etapa
